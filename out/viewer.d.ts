...
export interface InitOutput {
  ...
  readonly strftime_l: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly _tzset_js: (a: number, b: number, c: number, d: number) => void;
  readonly _mktime_js: (a: number) => void;
  readonly _localtime_js: (a: number, b: number) => void;
  readonly _gmtime_js: (a: number, b: number) => void;
  ...
  readonly abort: () => void;
  readonly __wasi_environ_sizes_get: (a: number, b: number) => number;
  readonly __wasi_environ_get: (a: number, b: number) => number;
  readonly __wasi_fd_seek: (a: number, b: number, c: number, d: number) => number;
  readonly __wasi_fd_read: (a: number, b: number, c: number, d: number) => number;
  readonly __wasi_fd_close: (a: number) => number;
  readonly emscripten_memcpy_js: (a: number, b: number, c: number) => void;
  readonly emscripten_get_heap_max: () => number;
  readonly emscripten_date_now: () => number;
  readonly _emscripten_get_now_is_monotonic: () => number;
  readonly emscripten_builtin_malloc: (a: number) => number;
  readonly __cxa_throw: (a: number, b: number, c: number) => void;
  readonly _initialize: () => void;
  readonly emscripten_errn: (a: number, b: number) => void;
  readonly malloc: (a: number) => number;
  readonly free: (a: number) => void;
  readonly __wasi_fd_write: (a: number, b: number, c: number, d: number) => number;
  readonly emscripten_get_now: () => number;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hf7363e2d903c9908: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h660996f99ba3f051: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hbf895ccf5070c4a2: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A_B___Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0a3613c701f86f15: (a: number, b: number, c: number, d: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he5d2ab9f711a8460: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h197900021fddcc12: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h37262886e36c7196: (a: number, b: number) => void;
